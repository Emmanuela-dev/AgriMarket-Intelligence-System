...
export const BASE_MARKET_PRICES: Record<string, Record<string, number>> = {
  ...
  'carrots': {
    ...
    '33': 3400, '34': 3350, '35': 3300, '36': 3100, '37': 3050, '38': 3000, '39': 3120, '40': 3200,
    ...
    '73': 4150, '74': 3650, '75': 3400, '76': 3300, '77': 3200, '78': 3100, '79': 3450, '80': 3380,
    '81': 3500, '82': 3420, '83': 3350, '84': 3080, '85': 3050, '86': 3020, '87': 3070, '88': 3470,
    '89': 3440, '90': 3490, '91': 3510, '92': 3460, '93': 3430, '94': 3480, '95': 3220, '96': 3600,
    '97': 3180, '98': 3590, '99': 3550, '100': 3380, '101': 3130, '102': 3200, '103': 3070, '104': 3030,
    '105': 3010, '106': 2980, '107': 3380, '108': 3320, '109': 2930, '110': 2980, '111': 3080, '112': 3100,
...
export const estimateTransportCost = (distance: number, quantity: number): number => {
  // Base cost per km per unit
  const costPerKmPerUnit = 0.5; // KES per km per unit
  return distance * quantity * costPerKmPerUnit;
};